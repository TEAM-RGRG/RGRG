...
class PartyOptionVC: UIViewController {
...
extension PartyOptionVC: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
