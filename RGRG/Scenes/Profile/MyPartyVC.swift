...
extension MyPartyVC {
    override func viewWillAppear(_ animated: Bool) {
        ...
        FBPartyManager.shared.loadMyParty { [weak self] parties in
...
extension MyPartyVC: UITableViewDelegate, UITableViewDataSource {
    func setUpTableView() {
        partyTable.register(PartyCell.self, forCellReuseIdentifier: "PartyTableViewCell")
