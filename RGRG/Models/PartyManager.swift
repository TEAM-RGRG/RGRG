        ...
        PartyManager.db.collection("party")
            .addDocument(data: [
                ...
                if let e = error {
                    ...
                    let party = PartyInfo(champion: party.champion, content: party.content, date: party.date, hopePosition: party.hopePosition, profileImage: party.profileImage, tier: party.tier, title: party.title, userName: party.userName, writer: party.writer)
                    completion(party)
                }
            }
    }
